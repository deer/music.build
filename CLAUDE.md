...
- `skills/music-composition/SKILL.md` — primary AI agent reference: note DSL, all 45 tools, patterns
...
- `music-server/src/main/java/build/music/server/MusicMcpServer.java` — all 45 tool registrations
